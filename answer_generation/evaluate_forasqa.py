...
file_path = '/srv/nfs/home/njnu_zrq/RankCoT/src/answer_generation/data/grpo_self_choose/cot_to_answer_llama3/asqa_query_to_answer_llama_1.jsonl'  
data = []
...
for i in range(len(data)):
        ...
        data[i]['model_answer'] = data[i]['COT'].replace("<|im_end|>", "")
# model_answer    COT
